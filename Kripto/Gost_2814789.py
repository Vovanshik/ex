...
def round(block, k_i, P):
    ...
    if P != 31: new_block = new_left_block + new_right_block
    else: new_block = new_right_block + new_left_block
    #print(new_block)
    return new_block
...
#to_gost = ['1100110011000101110010111100010111011000110010101100111000100000']
#New_Key = ['11001010110011101100110111010001', '11010010110000001100110111010010']
print(to_gost[0][:32] + " " + to_gost[0][32:])
...
for j in range(len(to_gost)):
    for i in range(32):
        ...
        to_gost[j] = round(to_gost[j], k_i, i)
        #print(f"{i} Раунд:  {to_gost[j][:32]}      {to_gost[j][32:]}")
print(to_gost)
