...
root2.geometry("220x123")

code = tk.Button(root2, text="Регистрация Алисы", command=check_A, font=("Helvetica", 12), bg="#CD950C", fg="black")
code.place(x=34, y=10)

Decode = tk.Button(root2, text="Регистрация Boba", command=check_B, font=("Helvetica", 12), bg="#CD950C", fg="black")
Decode.place(x=38, y=50)

complete = tk.Button(root2, text="Подтверждение связи", command=registr, font=("Helvetica", 12), bg="#CD950C", fg="black")
complete.place(x=25, y=90)
