...
class GraphicalPasswordApp:
    ...
    def load_image(self):
        if self.current_image_index < len(self.images):
            ...
            cell_width = 800 // self.columns
            cell_height = 600 // self.rows

            for i in range(1, self.rows):
                self.canvas.create_line(0, i * cell_height, 800, i * cell_height, fill="black")
            for i in range(1, self.columns):
                self.canvas.create_line(i * cell_width, 0, i * cell_width, 600, fill="black")
        else:
            self.save_passwords()
            self.master.destroy()
    ...
    def on_left_click(self, event):
        row = event.y // (600 // self.rows)
        column = event.x // (800 // self.columns)
...
class GraphicalPasswordAppLogin:
    ...
    def load_image(self):
        if self.current_image_index < len(self.images):
            ...
            for i in range(1, self.rows):
                self.canvas.create_line(0, i * cell_height, 800, i * cell_height, fill="red")
            for i in range(1, self.columns):
                self.canvas.create_line(i * cell_width, 0, i * cell_width, 600, fill="red")
        else:
            self.save_passwords()
            self.master.destroy()
...
def image_for_password():
    ...
    app = GraphicalPasswordApp(root, images, 100, 100)
...
def image_for_password2():
    ...
    app = GraphicalPasswordAppLogin(root, images, 40, 40)
    root.mainloop()
